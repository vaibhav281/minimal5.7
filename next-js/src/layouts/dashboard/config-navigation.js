    ...
    () => [
      ...
      // ----------------------------------------------------------------------
      {
        ...
        items: [
          ...
          {
            title: t('userListing'),
            path: paths.dashboard.userListing.root,
            icon: ICONS.user,
            children: [
              { title: t('profile'), path: paths.dashboard.userListing.root },
              { title: t('cards'), path: paths.dashboard.userListing.cards },
              { title: t('list'), path: paths.dashboard.userListing.list },
              { title: t('create'), path: paths.dashboard.userListing.new },
              { title: t('edit'), path: paths.dashboard.userListing.demo.edit },
              { title: t('account'), path: paths.dashboard.userListing.account },
            ],
          },
        ...
        items: [
          {
            ...
            // roles: ['user'] Only userListing can see this item.
